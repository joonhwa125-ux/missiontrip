  ...
  return (
    <>
      ...
      <button
        ...
        disabled={loading}
        className="flex min-h-11 w-full items-center justify-center gap-3 rounded-xl border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-main-action focus-visible:ring-offset-2 disabled:opacity-60"
        aria-label={loading ? "로그인하는 중" : "Google 계정으로 로그인"}
        aria-busy={loading}
      >
        {loading ? (
