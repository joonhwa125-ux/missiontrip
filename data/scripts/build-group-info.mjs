...
//
// 현재 확정분만 포함:
//   - 1일차 카카오 집결 (sort_order=8) — 18조 A/B 구분
//   - 1일차 포도원 본대 (sort_order=13) — 18조 좌석 영역
//   - 2일차 하효마을 집결 (sort_order=2) — 17조 식사 시각 구분 (선발조 제외)
//
...
const CAKAO_ORDER = 8;   // 1일차 카카오 스페이스닷 집결
const PODOWON_MAIN = 13; // 1일차 포도원 집결 (본대)
const HAHYO_ORDER = 2;   // 2일차 하효마을 집결
