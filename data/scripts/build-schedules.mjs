...
const SCHEDULES = [
  ...
  //   - 제주공항 도착 본대 티웨이/제주항공 통합 — 30분 차이, 다음 일정(난타 16:30)까지 4시간 여유
  //   - 카카오 스페이스닷 집결 삭제 — 제주공항 도착(본대) 체크 후 버스 단일 경로 이동, group_info A/B조 안내는 (1,3)으로 이관
  //   - 포도원(후발) 삭제 — 공항 도착(후발) 체크 후 단일 버스 30분 이동, 중간 체류 없음 (B2형 통합)
  // 네이밍 규칙: 장소 = 다음 이동 목적지(~行), 집결지(일정명) = 현재 모이는 장소
  // 항공편 정보(편명·시각)는 집결 일정의 airline_leg + notice로 이관 → 브리핑 AirlineSection에 표시
  // 시각 규칙: scheduled_time = 집결 시각 (행사·이동 시작 20분 전)
  //   · 앱 카드 표기 = 집결 시각 (조장이 "언제 모이나" 바로 확인)
  //   · 명찰 = 실제 행사 시각 (이동/행사 시작)
  //   · 도착 체크 일정은 도착 시각 그대로 유지 (마진 불필요)
  [1, 1,  "김포공항行 셔틀",                  "판교·성수 사옥 앞 집결",                "06:40", "선발", "출발", "",       "",       "07:00 셔틀 출발"],
  [1, 2,  "제주行 비행기 탑승",                "김포공항 3층 나래마루 집결 (본대)",        "07:40", "선발", "",    "가는편", "",       "티웨이 TW709 10:20 출발 · 제주항공 7C117 11:55 출발 · 티웨이 탑승자 08:00 집결 완료 / 제주항공 탑승자 10:00 집결 · 3층 신분증 확인 후 티켓 배부 · 버스깃발·명찰·무스비 배부"],
  [1, 3,  "카카오스페이스닷行 버스 탑승",       "제주공항 수하물 찾는 곳 (본대)",          "12:00", "선발", "",    "",       "",       "티웨이 12:00 도착 → 조 단위로 먼저 나가 가이드와 만남 (1,2조 먼저) · 제주항공 12:30 도착 → 공항 식당 점심 후 14:30 카카오行 버스 · 14:50 A조 투어 합류 · 13:30 카카오 도착 후 A/B조 분리 진행"],
  [1, 4,  "김포공항行 셔틀 버스 (판교 후발)",   "판교 배스킨라빈스",                     "13:10", "후발", "출발", "",       "",       "13:30 셔틀 출발"],
  [1, 5,  "제주行 비행기 탑승",                "김포공항 3층 나래마루 집결 (후발)",        "15:00", "후발", "",    "가는편", "티웨이", "티웨이 TW727 17:10 출발 · 헤더·리무는 16:00 집결"],
  [1, 6,  "난타공연 관람行",                  "난타극장으로 이동",                     "16:10", "선발", "",    "",       "",       "16:30 공연 시작 · 7호차 15조부터 역순 입장 · 뒷좌석은 이동 어려운 시각장애 고려"],
  [1, 7,  "저녁식사行",                      "포도원(식당) 집결 (본대)",              "18:10", "선발", "",    "",       "",       "18:30 저녁식사 시작 · 장애인화장실 없음 · 수목원으로 이동 필요"],
  [1, 8,  "포도원行 버스 탑승",                "제주공항 수하물 찾는 곳 (후발)",          "19:00", "후발", "",    "",       "",       "19:30 포도원 도착 후 본대와 저녁식사 합류 · 버스 하차 시 조장은 조원 인원 재확인"],
  [1, 9,  "숙소行",                         "신화월드 숙소 체크인 (본대)",            "20:30", "선발", "",    "",       "",       "버스에서 방장에게 카드키·조식쿠폰 배부"],
  [1, 10, "숙소行",                         "신화월드 숙소 체크인 (후발)",            "21:00", "후발", "",    "",       "",       "버스에서 방장에게 카드키·조식쿠폰 배부"],

  // ── 2일차 (4/24 금) ──
  // 하효마을 집결(도착) 삭제 — 성화정 출발 체크 후 단일 버스 80분 이동, 중간 정차 없음 (A형 통합)
  // 도착 후 식사 시각 안내·도착 재확인 문구는 성화정 카드 notice로 이관
  [2, 1, "신화월드 성화정",      "성화정 집결 (하효마을行)",       "10:40", "전체", "",    "",       "",       "11:00 버스 출발 · 12:00 하효마을 도착 후 조장은 조원 인원 재확인 (잔치체험 시작) · 1~6조·16조·17조 12:00 식사 시작 / 7~15조 12:30 식사 시작 · 4명씩 꽉 채워 앉기"],
  [2, 2, "하효마을",            "하효마을 출발 집결",            "13:40", "전체", "",    "",       "",       "14:00 더클리프行 버스 출발"],
  [2, 3, "더클리프",            "더클리프 출발 집결",            "16:10", "전체", "",    "",       "",       "16:30 신화월드行 버스 출발 · 더클리프 음료·푸드박스 배부"],
  // 메인행사 집결 (명찰: 19:30 메인행사 시작 · 20분 마진)
  [2, 4, "신화월드 랜딩볼룸",    "랜딩볼룸 집결 (메인행사)",        "19:10", "전체", "",    "",       "",       "18:00부터 사전행사(인생네컷·포토월) 자유 참여 · 19:30 메인행사 '모두의 축제' 시작 · 조장이 조원 동선 파악"],
  ...
  [3, 1, "신화월드 성화정",      "성화정 집결 (치유의숲行)",       "09:10", "전체", "",    "",       "",       "모든 짐 챙겨 이동 (체크아웃 완료 확인) · 09:30 버스 출발 · 10:00 치유의숲 도착 후 조장은 조원 인원 재확인 · 조원별 프로그램(해먹/족욕/숲체험) 확인 후 분산 · 근무자는 별도 배치"],
  [3, 2, "중문고등어쌈밥",       "고등어쌈밥 집결",              "12:10", "전체", "",    "",       "",       "12:30 점심 시작"],
  [3, 3, "제주공항 3층",         "제주공항 체크인/티켓발급",       "14:10", "전체", "",    "오는편", "",       "14:30 체크인 시작 · 본대 티웨이 TW726 16:25 출발 · 후발 에어서울 RS906 15:55 출발 · 교통약자는 바로 입구 앞 · 3층 티켓 배부"],
  [3, 4, "김포공항 수하물 찾는곳","김포공항 도착 인원체크 (후발)",   "17:00", "후발", "",    "",       "",       ""],
  [3, 5, "김포공항 수하물 찾는곳","김포공항 도착 인원체크 (본대)",   "17:30", "선발", "",    "",       "",       "조별 집결 · 판교아지트 셔틀 집결장소로 조장 인솔 · 개별 이동자는 해산"],
  [3, 6, "김포공항",            "성수/판교 귀가 셔틀 집결",       "18:10", "전체", "귀가", "",       "",       "18:30 셔틀 출발"],
];
...
// ─────────────────────────────────────────────
// 확정된 미참여 (사용자 지시 기반):
//   - 1일차 난타공연 관람 (sort_order=6): yul.9, bart.11, rose.es, kevin.s (카카오 삭제로 7→6)
//   - 1일차 포도원(본대) 저녁식사 (sort_order=7): rose.es, kevin.s (카카오 삭제로 8→7)
// 그 외는 pending-questions.md에 기록 (사용자 확인 후 추가)

// 확정된 미참여 (사용자 지시 기반)
const STATIC_MEMBER_INFO = [
  // 1일차 난타공연 관람 미참여
  [1, 6, "yul.9",   "미참여", "숙소 체크·카드키 분류 업무"],
  [1, 6, "bart.11", "미참여", "숙소 체크·카드키 분류 업무"],
  [1, 6, "rose.es", "미참여", "숙소 휴식"],
  [1, 6, "kevin.s", "미참여", "숙소 휴식"],
  // 1일차 포도원(본대) 저녁식사 미참여
