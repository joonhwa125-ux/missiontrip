...
// ─────────────────────────────────────────────
// schedules.csv
// 컬럼: 일차, 순서, 장소, 일정명, 예정시각, 대상, 셔틀여부, 항공구간
// ─────────────────────────────────────────────
const SCHEDULES = [
  // ── 1일차 (4/23 목) ── 본대 + 카페인기글 + 후발대 3개 흐름을 sort_order 시각순으로 정렬
  [1, 1,  "판교·성수 사옥",     "판교/성수 사옥 셔틀 집결",       "07:00", "선발", "출발", ""],
  [1, 2,  "김포공항 3층",      "김포공항 집결 (본대 티웨이)",     "08:00", "선발", "",    ""],
  [1, 3,  "김포공항 3층",      "김포공항 집결 (본대 제주항공)",    "10:00", "선발", "",    ""],
  [1, 4,  "김포공항 게이트",    "티웨이 TW709 탑승",            "10:20", "선발", "",    "가는편"],
  [1, 5,  "김포공항 게이트",    "제주항공 7C117 탑승",           "11:55", "선발", "",    "가는편"],
  [1, 6,  "제주공항 수하물 찾는곳","제주공항 도착 인원체크 (본대 티웨이)","12:00", "선발", "",  ""],
  [1, 7,  "제주공항 수하물 찾는곳","제주공항 도착 인원체크 (본대 제주항공)","12:30", "선발","",  ""],
  ...
  [3, 5, "제주공항 게이트",      "에어서울 RS906 탑승 (후발)",     "15:55", "후발", "",    "오는편"],
  [3, 6, "제주공항 게이트",      "티웨이 TW726 탑승 (본대)",      "16:25", "선발", "",    "오는편"],
...
function writeSchedules() {
  const header = ["일차","순서","장소","일정명","예정시각","대상","셔틀여부","항공구간"];
